                ...
                with dpg.tab(label="Tools"):
                    ...
                    with dpg.tree_node(label="Drag Lines/Points"):
                        ...
                        with dpg.plot(label="Drag Lines/Points", height=400, width=-1):
                            ...
                            dpg.add_drag_line(label="dline1", tag="HELLO", color=[255, 0, 0, 255],callback=lambda s, a: print(s, a))
...
def create_theme_imgui_dark():
    ...
    with dpg.theme() as theme_id:
        with dpg.font_registry():
            default_font = dpg.add_font("consola.ttf", 40)
        ...
        with dpg.theme_component(0):
            ...
            #Graph
            dpg.add_theme_style(dpg.mvPlotStyleVar_LineWeight, 5)
